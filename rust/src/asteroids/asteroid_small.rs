...
use crate::asteroids::asteroid::{AsteroidIFunctions, AsteroidSize};
...
impl IArea2D for SmallAsteroid {
    fn ready(&mut self) {
        ...
        self.rotation_speed = randi_range(4, 5) as i32;
        self.horizontal_speed = randi_range(40, 55) as f32 * self.direction.x;
